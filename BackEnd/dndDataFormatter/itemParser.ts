...
export const parseAbilityModifiers = (itemModifier: OriginalItemAbilityModifier): {abilityModifiers: abilityModifiers, abilityOverrides: abilityModifiers} => {
